...
const SafetySlider = class {
  ...
  render() {
    return (index.h(index.Host, { class: "safety-slider", id: SLIDER_ID_PREFIX + this.uuid }, index.h("safety-slider-window", { activeSlide: this.activeSlide, isInfinite: this.isInfinite, uuid: this.uuid }, index.h("slot", null)), this.slideCount > 1 && !this.hasNoArrows && (index.h("safety-slider-arrows", { slideCount: this.slideCount, activeSlide: this.activeSlide, prevArrowInnerHTML: this.prevArrowInnerHTML, nextArrowInnerHTML: this.nextArrowInnerHTML, isInfinite: this.isInfinite, prevAriaLabel: this.prevArrowAriaLabel, nextAriaLabel: this.nextArrowAriaLabel, uuid: this.uuid })), this.slideCount > 1 && !this.hasNoDots && (index.h("safety-slider-dots", { activeDot: this.activeSlide, dotCount: this.slideCount, dotAriaLabel: this.dotAriaLabel, uuid: this.uuid }))));
  }
  get root() { return index.getElement(this); }
};
SafetySlider.style = safetySliderCss;
...
const SafetySliderArrows = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.safetySliderNavigationClick = index.createEvent(this, "safetySliderNavigationClick", 7);
    this.slideCount = 2;
    this.activeSlide = 0;
    this.prevArrowInnerHTML = '←';
    this.nextArrowInnerHTML = '→';
...
const SafetySliderDots = class {
  ...
  render() {
    return (index.h(index.Host, null, this.dotButtons.map((i) => index.h("button", { class: DOT_CLASS, type: "button", disabled: i === this.activeDot, onClick: this.dotClick, "aria-label": this.getFormattedAriaLabel(i + 1), "aria-controls": WINDOW_ID_PREFIX + this.uuid, "data-slide": i }))));
  }
};
SafetySliderDots.style = safetySliderDotsCss;
...
const SafetySliderWindow = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.safetySliderInfiniteLoopAdjustment = index.createEvent(this, "safetySliderInfiniteLoopAdjustment", 7);
    this.safetySliderApplyTransitionDuration = index.createEvent(this, "safetySliderApplyTransitionDuration", 7);
  ...
  render() {
    return (index.h(index.Host, { id: WINDOW_ID_PREFIX + this.uuid, style: {
      ...
      } }, index.h("div", { class: SLIDE_TRACK_CLASS, ref: (el) => this.trackElement = el }, this.isInfinite && this.slideCount > 1 && (index.h("div", { class: SLIDE_CLONE_CLASS, innerHTML: this.beginningClone })), index.h("slot", null), this.isInfinite && this.slideCount > 1 && (index.h("div", { class: SLIDE_CLONE_CLASS, innerHTML: this.endingClone })))));
  }
  get root() { return index.getElement(this); }
...
SafetySliderWindow.style = safetySliderWindowCss;

exports.safety_slider = SafetySlider;
exports.safety_slider_arrows = SafetySliderArrows;
exports.safety_slider_dots = SafetySliderDots;
exports.safety_slider_window = SafetySliderWindow;
